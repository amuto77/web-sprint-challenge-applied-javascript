...
1. What is the DOM?
    The DOM is a document model loaded in the browser and representing the document as a node tree, where each node represents part of the document.
2. What is an event?
    Events are sent to notify code of interesting things that have taken place.
3. What is an event listener?
    The EventListener interface represents an object that can handle an event dispatched by an EventTarget object.
4. Why would we convert a NodeList into an Array?
    Converting a NodeList into an array allows array methods to be used on it (i.e. .map, forEach, etc.).

5. What is a component?
    Components allow you to create reusable custom elements — with their functionality encapsulated away from the rest of your code — and can be utilized in web apps.
